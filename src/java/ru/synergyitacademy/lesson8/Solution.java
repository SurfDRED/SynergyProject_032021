        ...
        try (BufferedReader br = new BufferedReader(new InputStreamReader(System.in))) {
            while (true) {
                ...
                switch (select) {
                    case 1:
                        if (tempInput >= -273.0) {
                            System.out.println("Результат: " + tempInput + " С = " + Converter.getConverter(Temperature.CELS_FAXR).convert(tempInput) + " F");
                        } else {
                    ...
                    case 2:
                        if (tempInput >= -273.0) {
                            System.out.println("Результат: " + tempInput + " С = " + Converter.getConverter(Temperature.CELS_KELV).convert(tempInput) + " K");
                        } else {
                            System.out.println("Значение температуры не может быть меньше -273 С");
                        }
                        break;
                    case 3:
                        if (tempInput >= -459.4) {
                            System.out.println("Результат: " + tempInput + " F = " + Converter.getConverter(Temperature.FAXR_CELS).convert(tempInput) + " C");
                        } else {
                    ...
                    case 4:
                        if (tempInput >= -459.4) {
                            System.out.println("Результат: " + tempInput + " F = " + Converter.getConverter(Temperature.FAXR_KELV).convert(tempInput) + " K");
                        } else {
                            System.out.println("Значение температуры не может быть меньше -459.4 F");
                        }
                        break;
                    case 5:
                        if (tempInput >= 0) {
                            System.out.println("Результат: " + tempInput + " K = " + Converter.getConverter(Temperature.KELV_CELS).convert(tempInput) + " C");
                        } else {
                    ...
                    case 6:
                        if (tempInput >= 0) {
                            System.out.println("Результат: " + tempInput + " K = " + Converter.getConverter(Temperature.KELV_FAXR).convert(tempInput) + " F");
                        } else {
                            System.out.println("Значение температуры не может быть меньше 0 K");
                        }
                        break;
